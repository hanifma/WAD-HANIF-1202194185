    ...
    if (isset($_POST["update"])) {
        ...
        if (!in_array($ext, $ekstensi)) {
            header("location:hanif_detail.php?id_buku=$id_buku&alert=file_extension_not_allowed");
            ...
            if ($ukuran < 3044070) {
                ...
                move_uploaded_file($_FILES['gambar']['tmp_name'], 'img/' . $rand . '_' . $filename);
                mysqli_query($koneksi, $query);
                header("location:hanif_detail.php?id_buku=$id_buku&alert=success");
            } else {
                header("location:hanif_detail.php?id_buku=$id_buku&alert=file_size_exceeded");
            }
        }
    }
    ...
    <html>
        ...
        <body>
            ...
            <center><img src='img/<?= $select['gambar'] ?>' class='shadow-lg' style='height: 450px; width:auto'></center><br><hr style="color:blue;">
                    ...
                    <div class="row mt-5">
                            ...
                            <a href="hanif_delete.php?id_buku=<?= $select["id_buku"] ?>" class="col btn btn-danger ms-3">Hapus</a>
                    </div>
            </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <input type="hidden" name="id_buku" value="<?= $select["id_buku"] ?>">
                                        ...
                                        <div class="form-group">
                                            <label class='title'>Penulis</label>
                                            <input type="text" id='penulis_buku' name='penulis_buku' class="form-control" value="Hanif_1202194185" readonly value="<?= $select['penulis']?>">
                                        </div>
                                        <div class="form-group">
                                            <label class='title'>Tahun Terbit</label>
                                            <input type="number" id='tahun_terbit' name='tahun_terbit' class="form-control" placeholder="Contoh: 1990" value="<?= $select['tahun_terbit']?>">
                                        </div>
                                        <div class="form-group">
                                            <label class='title'>Deskripsi</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name='tag[]' value=" Website" <?php if(in_array(" Website",$tag)) echo 'checked'; ?>>
                                                <label class="form-check-label" for="inlineCheckbox2">Website</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name='tag[]' value=" Java" <?php if(in_array(" Java",$tag)) echo 'checked'; ?>>
                                                <label class="form-check-label" for="inlineCheckbox3">Java</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name='tag[]' value=" OOP" <?php if(in_array(" OOP",$tag)) echo 'checked'; ?>>
                                                <label class="form-check-label" for="inlineCheckbox1">OOP</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name='tag[]' value=" MVC" <?php if(in_array(" MVC",$tag)) echo 'checked'; ?>>
                                                <label class="form-check-label" for="inlineCheckbox2">MVC</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name='tag[]' value=" Kalkulus" <?php if(in_array(" Kalkulus",$tag)) echo 'checked'; ?>>
                                                <label class="form-check-label" for="inlineCheckbox3">Kalkulus</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name='tag[]' value=" Lainnya" <?php if(in_array(" Lainnya",$tag)) echo 'checked'; ?>>
